...
import CardWrapper from './components/listCardPlayers/CardWrapper';
import CardWrapperTeams from './components/listCardTeams/CardWrapperTeams';
...
const AppMain = () => {
    ...
    return (
        <Routes>
            ...
            <Route path="/list/teams" element={<CardWrapperTeams />} />
